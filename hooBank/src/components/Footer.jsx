  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex flex-1 flex-col justify-start mr-10 md:mb-0 mb-3">
          <img
            src={logo}
            alt="hoobank"
      ...
      <div
       ...
       items-center pt-6 border-t-[1px] border-t-[#3f3e45]
      "
      >
        <p className="text-center font-poppins font-normal text-[18px] leading-[27px]">
